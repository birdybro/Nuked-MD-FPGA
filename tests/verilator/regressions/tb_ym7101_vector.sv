...
module tb_ym7101_vector;
  localparam integer VEC_WIDTH = 85;
  localparam integer VEC_COUNT = 512;
  ...
  initial begin
    $readmemh("tests/verilator/regressions/vectors/ym7101_vectors.mem", vectors);
    ...
    for (i = 0; i < VEC_COUNT; i = i + 1) begin
      ...
      {SD, RD_i, AD_i, SPA_B_i, CSYNC_i, HSYNC_i, HL, SEL0, PAL, RESET, CD_i, CA_i,
       BGACK_i, BG, MREQ, INTAK, IORQ, RD, WR, M1, AS, UDS, LDS, RW, DTACK_i, ext_test_2, vdp_cramdot_dis} = v;
      #2;
